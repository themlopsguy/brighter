// app/onboarding/veteranStatus.tsx
...
export default function OnboardingVeteranStatus() {
  ...
  // Animation refs for each button (3 options for veteran status)
  ...
  const veteranStatusOptions = [
    { label: 'I am a protected veteran', value: 'yes' },
  ...
  return (
    <View style={styles.content}>
      <View style={[
        ...
        {/* Scrollable VeteranStatus Selection Buttons */}
        <ScrollView
          style={[
        ...
        >
          {veteranStatusOptions.map((option, index) => {
